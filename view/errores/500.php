...
<head>
    ...
    <title>500 - Error interno del servidor | Argen Medical</title>
...
<body class="flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-2xl shadow-2xl p-8 transform transition-all duration-300 hover:shadow-3xl text-center">
            ...
            <div class="mx-auto w-20 h-20 bg-gradient-to-br from-red-100 to-orange-100 rounded-full flex items-center justify-center mb-4 shadow-inner floating">
                <i class="fas fa-server text-3xl text-red-600"></i>
            </div>

            <div class="error-code">500</div>

            <h2 class="text-2xl font-bold text-gray-800 mt-2">Error interno del servidor</h2>
