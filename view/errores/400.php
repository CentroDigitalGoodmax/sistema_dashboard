...
<head>
    ...
    <title>400 - Solicitud incorrecta | Argen Medical</title>
    <meta name="description" content="La solicitud enviada no es válida">
...
<body class="flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-2xl shadow-2xl p-8 transform transition-all duration-300 hover:shadow-3xl text-center">
            ...
            <h2 class="text-2xl font-bold text-gray-800 mt-2">Solicitud incorrecta</h2>
