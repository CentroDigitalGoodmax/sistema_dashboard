...
<head>
    ...
    <title>404 - Página no encontrada | Argen Medical</title>
...
<body class="flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-2xl shadow-2xl p-8 transform transition-all duration-300 hover:shadow-3xl text-center">
            ...
            <div class="mx-auto w-20 h-20 bg-gradient-to-br from-indigo-100 to-purple-100 rounded-full flex items-center justify-center mb-4 shadow-inner floating">
                <i class="fas fa-map-signs text-3xl text-indigo-600"></i>
            </div>

            <div class="error-code">404</div>

            <h2 class="text-2xl font-bold text-gray-800 mt-2">Página no encontrada</h2>
