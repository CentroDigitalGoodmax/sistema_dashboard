...
<head>
    ...
    <title>403 - Acceso denegado | Argen Medical</title>
    <meta name="description" content="No tienes permisos para ver esta página">
...
<body class="flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-2xl shadow-2xl p-8 transform transition-all duration-300 hover:shadow-3xl text-center">
            ...
            <div class="mx-auto w-20 h-20 bg-gradient-to-br from-yellow-100 to-red-100 rounded-full flex items-center justify-center mb-4 shadow-inner floating">
                <i class="fas fa-ban text-3xl text-red-600"></i>
            </div>

            <div class="error-code">403</div>

            <h2 class="text-2xl font-bold text-gray-800 mt-2">Acceso denegado</h2>
            <p class="text-gray-500 text-sm mt-2 mb-6">
                No tienes permisos para ver esta página o recurso.
            </p>
